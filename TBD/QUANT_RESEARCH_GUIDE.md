...
**当前指标**（P0 后更新）：
- test spearman: **0.0313**（21 因子 Purged K-Fold，原 0.059 是泄漏假象）
- 因子数: 199 → **21**（去冗余后）
- 顶特征: `realized_vol_10_lag15` (gain=31.56)、`downside_vol_20_lag0`、`ema_gap_12_26_lag15`
- 主要问题: **绝对值仍很低**，瓶颈在标签设计而非因子数
